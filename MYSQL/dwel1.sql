...
ALTER TABLE `comments` ADD `like_count` INT( 11 ) NOT NULL DEFAULT '0' AFTER `comment` ;
ALTER TABLE `comments` ADD `dislike_count` INT( 11 ) NOT NULL DEFAULT '0' AFTER `like_count` ;  
